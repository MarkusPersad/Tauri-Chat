<template>
    <div class="flex h-screen w-16 flex-col justify-between border-r border-blue-500 bg-blue-500">
        <div>
            ...
            <div class="border-t border-blue-500">
                <div class="px-2">
                    ...
                    <ul class="space-y-1 border-t border-blue-500 pt-4">
                        <li>
                            <a href="#"
                                class="group relative flex justify-center rounded-sm px-2 py-1.5 text-white hover:bg-gray-50 hover:text-black">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5 opacity-75" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
